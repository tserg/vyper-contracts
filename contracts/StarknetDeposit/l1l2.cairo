...
const L1_CONTRACT_ADDRESS = (
    0x53c3a4FF1482767Cde76935f47A2C0bb6365A2Ea)
const MESSAGE_WITHDRAW = 0

# Modified to L2 address
# A mapping from a user to their balance.
@storage_var
...
func withdraw{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(
        user : felt, user_l1_address : felt, amount : felt):
    ...
    # Add a new argument for L1 address that can withdraw
    assert message_payload[2] = user_l1_address
